...
@Autonomous(name="LeftAutoRed", group="Autonomous")
...
// Send telemetry message to indicate successful Encoder reset
        ...
        if ((pipeline.HSV_Value_1[0] < pipeline.HSV_Value_2[0]) && (pipeline.HSV_Value_1[0] < pipeline.HSV_Value_3[0])){
            ...
            encoderDrive(DS, 40.75, -40.75, 40.75, -40.75);
            sleep(100);

            encoderDrive(DS, 25.25, -25.25, -25.25, 25.25);
            sleep(100);
            ...
            robot.armMotor.setPower(-0.0012);
            sleep(750);
            ...
            encoderDrive(DS, 40, -40, 40, -40);
            sleep(100);

            encoderDrive(DS, 24.5, -24.5, -24.5, 24.5);
            sleep(100);
