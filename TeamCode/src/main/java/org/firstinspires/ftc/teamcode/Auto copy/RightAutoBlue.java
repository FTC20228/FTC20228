...
@Autonomous(name="RightAutoBlue", group="Autonomous")
...
// Send telemetry message to indicate successful Encoder reset
        ...
        if ((pipeline.HSV_Value_1[0] < pipeline.HSV_Value_2[0]) && (pipeline.HSV_Value_1[0] < pipeline.HSV_Value_3[0])){
            ...
            encoderDrive(DS, 6, -6, -6, 6);
            sleep(1000);

            encoderDrive(DS, -31, 31, -31, 31);
            sleep(1000);

            robot.spinnerDuck.setPower(1);
            sleep(3500);

            robot.spinnerDuck.setPower(0);
            sleep(100);

            encoderDrive(DS, 33.75, -33.75, -33.75, 33.75);
            sleep(100);

            encoderDrive(DS, 21, 21, 21, 21);
            sleep(1000);

            encoderDrive(DS, 23.25, -23.25, -23.25, 23.25);
            sleep(100);
            ...
            encoderDrive(DS, -25, 25, 25, -25);
            sleep(100);

            encoderDrive(DS, 18, -18, 18, -18);
            sleep(100);
            ...
            encoderDrive(DS, 24.25, -24.25, -24.24, 24.25);
            sleep(100);
